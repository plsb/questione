...
const EvaluationsResultStudentOverviewQuestion = props => {
...
EvaluationsResultStudentOverviewQuestion.propTypes = {
  className: PropTypes.string,
  result: PropTypes.object,
  numberQuestion: PropTypes.number,
};

export default EvaluationsResultStudentOverviewQuestion;
