...
Route::group(['prefix' => 'evaluation/practice'], function (){
    ...
    Route::get('/applications/status/{evaluation}', 'Practice\EvaluationApplicationsPracticeController@statusApplication')->name('evaluationApplication.practice.status');
