...
class QuestionItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!$question){
            return response()->json([
                'message' => 'Operação não realizada. A Questão não foi encontrada.'
            ], 203);
        }
        ...
        if($count_items_stored >= 5){
            return response()->json([
                'message' => 'Operação não realizada. A Questão já possui 05 itens de resposta.'
            ], 203);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $question_item->description = $request->description;
        $question_item->correct_item = $request->correct_item;
        $question_item->correct_item = $correct_item ;
        $question_item->save();
